...
for(i in 1:n){
  if((0 < Vn[i]) & (Vn[i] < 1-1/n)){
    T = unique(c(Vn[i],Vn[(Vn[i] <= Vn) & (Vn < 1-1/n)],1-1/n))
...
write.csv(x=data.frame(cbind(W,Phi_true,Phi_est_int,Phi_est_diff)),
          file=paste0("/Users/magloireloudeguidjimdou/Documents/Articles/PhD - Chapter 3/phi_estim_",tolower(CopulaName),"_",n,".csv"),
          row.names = FALSE)
...
CopulaName <- 'Frank' # select the copula from the list c('Indep','Clayton','AMH','Frank')
...
write.csv(x=lossalae_foroverleaf,
          file="/Users/magloireloudeguidjimdou/Documents/Articles/PhD - Chapter 3/Statistics/submission 2/lossalae_uncensored.csv",
          row.names = FALSE)
...
write.csv(x=phi_estim_ALAE,
          file="/Users/magloireloudeguidjimdou/Documents/Articles/PhD - Chapter 3/Statistics/submission 2/phi_estim_ALAE.csv",
          row.names = FALSE)
...
write.csv(x=confidence_bands_foroverleaf,
          file="/Users/magloireloudeguidjimdou/Documents/Articles/PhD - Chapter 3/Statistics/submission 2/confidence_bands_ALAE.csv",
          row.names = FALSE,na="")
